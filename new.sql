...
(
    ...
    `day_weather`   varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_zh_0900_as_cs NULL DEFAULT NULL COMMENT '白天天气',
    `night_weather` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_zh_0900_as_cs NULL DEFAULT NULL COMMENT '夜间天气',
    `day_temp`      varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_zh_0900_as_cs NULL DEFAULT NULL COMMENT '白天温度',
    `night_temp`    varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_zh_0900_as_cs NULL DEFAULT NULL COMMENT '夜间温度',
    `day_wind`      varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_zh_0900_as_cs NULL DEFAULT NULL COMMENT '白天风向',
    `night_wind`    varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_zh_0900_as_cs NULL DEFAULT NULL COMMENT '夜间风向',
    `day_power`     varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_zh_0900_as_cs NULL DEFAULT NULL COMMENT '白天风力',
    `night_power`   varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_zh_0900_as_cs NULL DEFAULT NULL COMMENT '夜间风力',
    `repor_ttime`   datetime NULL DEFAULT NULL COMMENT '预报发布时间',
    `create_time`   datetime NULL DEFAULT NULL COMMENT '创建时间',
    `update_time`   datetime NULL DEFAULT NULL COMMENT '更新时间',
    `delete_time`   datetime NULL DEFAULT NULL COMMENT '删除时间',
    `report_time`   datetime NULL DEFAULT NULL COMMENT '预报发布时间',
    PRIMARY KEY (`id`) USING BTREE
